...
export default function OnboardingPage() {
  ...
  if (loading) {
    return <div className="flex min-h-[calc(100vh-80px)] items-center justify-center"><Loader2 className="animate-spin h-10 w-10 text-tertiary" /></div>
  }
  ...
  if (!profile || !profile.is_approved) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-6">
        ...
        <p className="text-secondary font-medium text-center max-w-lg mb-8">
          ...
          <Step>
            <div className="flex flex-col gap-4 text-center">
              ...
              <p className="text-secondary font-medium">
                You&apos;ve been approved! Let&apos;s get your academic workspace configured. We just need your Moodle credentials to power your dashboard.
              </p>
            </div>
          </Step>
          <Step>
            <div className="flex flex-col gap-6 items-center">
              ...
              <p className="text-secondary font-medium text-sm text-center mb-4">
